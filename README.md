...
- **Experience:** 20+ years in software & web development 🏆
- **Specialization:** LLM automation, chatbots and websites for business 🔍
- **Philosophy:** Ship fast, iterate with users, automate the boring parts 🚀

## Services

What I can build for you:

- 💬 **Chatbots & AI assistants** · Telegram, WhatsApp, Discord, Slack, web widgets
- 🧠 **LLM integrations** · OpenAI, Anthropic Claude, Gemini, custom GPTs, function calling
- 📚 **RAG & custom knowledge bases** · chat with your docs, support automation, internal search
- 🤖 **AI agents** · multi-step tools, autonomous workflows, MCP integrations
- ⚙️ **Workflow automation** · n8n, Make, Zapier, custom Python/Node scripts
- 🌐 **Web apps & landing pages** · Next.js, modern stack, fast time-to-launch
- 🛒 **E-commerce & checkout** · Stripe, custom carts, subscriptions, payment flows
- 🎙️ **Voice & speech AI** · Whisper transcription, ElevenLabs TTS, voice bots
- 🖼️ **Image & vision AI** · DALL·E, Stable Diffusion, GPT-4 Vision pipelines
- 🕸️ **Scraping & data pipelines** · Playwright, Puppeteer, API ingestion, ETL
- 📊 **Dashboards & internal tools** · admin panels, analytics, CRUD apps
- 🔌 **API & systems integration** · CRMs, ERPs, third-party APIs, webhooks
- 🧪 **MVP development** · idea to launch in weeks, not months
- 🎯 **AI consulting & audits** · pick the right model, prompt design, cost optimization
...
![LlamaIndex](https://img.shields.io/badge/LlamaIndex-6E48AA?style=flat)
...
![Chroma](https://img.shields.io/badge/Chroma-FF6F61?style=flat)
...
![WhatsApp](https://img.shields.io/badge/WhatsApp%20Business-25D366?style=flat&logo=whatsapp&logoColor=white)
